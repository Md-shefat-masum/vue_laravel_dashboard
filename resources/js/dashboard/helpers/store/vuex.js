    ...
    */
    states(store_prefix = this.store_prefix, start_page = this.start_page, paginate = this.paginate) {
        ...
        const state = {
            ...
            [`${store_prefix}_show_filter_canvas`]: false,
        };
    ...
    */
    ...
    getters() {
        ...
        const getters = {
            ...
            [`get_${store_prefix}_show_filter_canvas`]: (state) => state[`${store_prefix}_show_filter_canvas`],
    ...
    */
    actions() {
        ...
        let actions = {
            ...
            [`fetch_${store_prefix}s`]: async function ({ state }, data = {}) {
                ...
                if (Object.keys(data).length > 0) {
                    for (const [key, value] of Object.entries(data)) {
                        if(value){
                            url.searchParams.set(`conditions[${key}]`, value);
                        }
                    }
                }
            ...
            /** permenanent delete */
            [`delete_${store_prefix}`]: async function ({ state, getters, dispatch }, id) {
    ...
    mutations() {
        ...
        const mutations = {
            ...
            * */
            ...
            [`set_${store_prefix}_show_filter_canvas`]: function (state, trigger = true) {
                console.log(trigger);

                state[`${store_prefix}_show_filter_canvas`] = trigger; // true or false
            },
