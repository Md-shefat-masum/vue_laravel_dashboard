<template>
    ...
    <PinturaEditorModal v-bind="props" v-if="visible" :src="src" @pintura:hide="visible = false"
        @pintura:show="handleShow()" @pintura:close="handleClose()" @pintura:load="handleLoad($event)"
        @pintura:loaderror="handleLoadError($event)" @pintura:loadabort="handleLoadAbort($event)"
